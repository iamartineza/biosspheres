...
def k_with_v_check() -> None:
    ...
    plt.colorbar()
    plt.title(
        "Absolute error between $K_{2,1}^0$ and"
...
def w_transpose_check() -> None:
    ...
    data_w12 = crossinteractions.w_0_sj_from_v_sj(
        data_v12, radio_2, radio_1, el_diagonal
    )
    data_w21 = crossinteractions.w_0_sj_from_v_sj(
        data_v21, radio_1, radio_2, el_diagonal
    )
...
def w_with_ka_and_v() -> None:
    ...
    data_ka21 = crossinteractions.ka_0_sj_from_v_sj(
        data_v21, radio_2, el_diagonal
    )

    data_w21 = -crossinteractions.k_0_sj_from_v_0_sj(
        data_ka21, radio_1, el_diagonal
    )
    data_w21_v2 = crossinteractions.w_0_sj_from_v_sj(
        data_v21, radio_1, radio_2, el_diagonal
    )

    aux_w = np.abs(data_w21 - data_w21_v2)
    plt.figure()
    plt.imshow(aux_w, cmap="RdBu", norm=colors.SymLogNorm(linthresh=10 ** (-8)))
    plt.colorbar()
    plt.show()
    pass
