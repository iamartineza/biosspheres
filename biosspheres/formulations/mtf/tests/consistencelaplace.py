...
def testing_mtf_linear_operators_and_matrices_laplace_one_sphere(
...
def testing_mtf_linear_operators_and_matrices_laplace_n_spheres(
) -> None:
    n = 3
    big_l = 5
    big_l_c = 10
...
if __name__ == '__main__':
    testing_mtf_linear_operators_and_matrices_laplace_n_spheres()
    testing_mtf_linear_operators_and_matrices_laplace_one_sphere()
